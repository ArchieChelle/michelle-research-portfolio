...
SE Play had recently entered the competitive live-streaming market for youth and recreational sports. Growth depended on more than acquisition. The product needed subscription tiers that matched what families, athletes, and sports organizations valued enough to keep paying for.

Pricing conversations were already connected to churn and customer lifetime value. This study made that conversation more precise: before the team could change price, it needed to understand whether each tier carried the right feature value.

## The challenge

The team needed to know which features users valued most, whether those features fit the tiers where they lived, and where misalignment could put retention at risk. The hard part was evidentiary: feature usefulness, willingness to pay, churn causality, and CLTV are related signals, but they are not the same measurement.

I treated the study as a tier-feature fit analysis first. That boundary mattered because the survey could inform pricing strategy, but it could not, by itself, prove willingness to pay or predict churn.
